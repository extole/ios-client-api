//
// V4runtimePersonspersonIdjourneysAPI.swift
//
...
open class V4runtimePersonspersonIdjourneysAPI {
    /**
     Get a journey
     ...
     */
    open class func getJourney1(personId: String, journeyId: String, completion: @escaping ((_ data: PersonJourneyResponse?,_ error: Error?) -> Void)) {
        getJourney1WithRequestBuilder(personId: personId, journeyId: journeyId).execute { (response, error) -> Void in
  ...
  "updated_date" : "2000-01-23T04:56:07.000+00:00"
     ...
     */
    open class func getJourney1WithRequestBuilder(personId: String, journeyId: String) -> RequestBuilder<PersonJourneyResponse> {
