...
open class V4runtimePersonsAPI {
    /**
     ...
     */
    open class func create6(body: PersonRequest, completion: @escaping ((_ data: PersonResponse?,_ error: Error?) -> Void)) {
        create6WithRequestBuilder(body: body).execute { (response, error) -> Void in
  ...
  "email" : "email"
     ...
     */
    open class func create6WithRequestBuilder(body: PersonRequest) -> RequestBuilder<PersonResponse> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func get5(email: String? = nil, partnerUserId: String? = nil, lastName: String? = nil, limit: Int? = nil, offset: Int? = nil, partnerId: [String]? = nil, completion: @escaping ((_ data: [PersonResponse]?,_ error: Error?) -> Void)) {
        get5WithRequestBuilder(email: email, partnerUserId: partnerUserId, lastName: lastName, limit: limit, offset: offset, partnerId: partnerId).execute { (response, error) -> Void in
            completion(response?.body, error)
        }
    }
  ...
  "email" : "email"
     ...
     - returns: RequestBuilder<[PersonResponse]> 
     */
    open class func get5WithRequestBuilder(email: String? = nil, partnerUserId: String? = nil, lastName: String? = nil, limit: Int? = nil, offset: Int? = nil, partnerId: [String]? = nil) -> RequestBuilder<[PersonResponse]> {
        let path = "/v4/runtime-persons"
        let URLString = ExtoleClientAPIAPI.basePath + path
  ...
  "person_id" : "person_id"
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func isSamePerson2(firstPersonId: String, personId: String? = nil, completion: @escaping ((_ data: IsSamePersonResponse?,_ error: Error?) -> Void)) {
        isSamePerson2WithRequestBuilder(firstPersonId: firstPersonId, personId: personId).execute { (response, error) -> Void in
            completion(response?.body, error)
        }
    }
  ...
  "is_same" : true
     ...
     */
    open class func isSamePerson2WithRequestBuilder(firstPersonId: String, personId: String? = nil) -> RequestBuilder<IsSamePersonResponse> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func update4(body: PersonRequest, personId: String, completion: @escaping ((_ data: PersonResponse?,_ error: Error?) -> Void)) {
        update4WithRequestBuilder(body: body, personId: personId).execute { (response, error) -> Void in
            completion(response?.body, error)
        }
    }
  ...
  "email" : "email"
     ...
     - returns: RequestBuilder<PersonResponse> 
     */
    open class func update4WithRequestBuilder(body: PersonRequest, personId: String) -> RequestBuilder<PersonResponse> {
        var path = "/v4/runtime-persons/{person_id}"
        let personIdPreEscape = "\(personId)"
        let personIdPostEscape = personIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{person_id}", with: personIdPostEscape, options: .literal, range: nil)
