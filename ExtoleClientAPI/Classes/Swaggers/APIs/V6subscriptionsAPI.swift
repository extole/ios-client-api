...
open class V6subscriptionsAPI {
     ...
     */
    open class func listSubscriptions1(havingAnyTags: String? = nil, havingAllTags: String? = nil, completion: @escaping ((_ data: [SubscriptionResponse]?,_ error: Error?) -> Void)) {
        listSubscriptions1WithRequestBuilder(havingAnyTags: havingAnyTags, havingAllTags: havingAllTags).execute { (response, error) -> Void in
  ...
  "user" : {
     ...
     */
    open class func listSubscriptions1WithRequestBuilder(havingAnyTags: String? = nil, havingAllTags: String? = nil) -> RequestBuilder<[SubscriptionResponse]> {
