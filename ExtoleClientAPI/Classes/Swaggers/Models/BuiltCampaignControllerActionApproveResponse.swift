//
// BuiltCampaignControllerActionApproveResponse.swift
//
...
public struct BuiltCampaignControllerActionApproveResponse: Codable {
    ...
    public init(actionId: String? = nil, actionType: ActionType? = nil, quality: Quality? = nil, componentReferences: [CampaignComponentReferenceResponse]? = nil, legacyActionId: String? = nil, partnerEventId: String? = nil, eventType: String? = nil, force: String? = nil, note: String? = nil, causeType: String? = nil, pollingId: String? = nil, pollingName: String? = nil) {
