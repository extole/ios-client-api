//
// BuiltCampaignControllerActionStepSignalResponse.swift
//
...
public struct BuiltCampaignControllerActionStepSignalResponse: Codable {
    ...
    public init(actionId: String? = nil, actionType: ActionType? = nil, quality: Quality? = nil, componentReferences: [CampaignComponentReferenceResponse]? = nil, pollingId: String? = nil, name: String? = nil) {
