//
// BuiltCampaignControllerTriggerDataIntelligenceEventResponse.swift
//
...
public struct BuiltCampaignControllerTriggerDataIntelligenceEventResponse: Codable {
    ...
    public init(triggerId: String? = nil, triggerType: TriggerType? = nil, triggerPhase: TriggerPhase? = nil, triggerName: String? = nil, componentReferences: [CampaignComponentReferenceResponse]? = nil, eventName: String? = nil) {
