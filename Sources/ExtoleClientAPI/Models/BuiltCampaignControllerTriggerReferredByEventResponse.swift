//
// BuiltCampaignControllerTriggerReferredByEventResponse.swift
//
...
public struct BuiltCampaignControllerTriggerReferredByEventResponse: Codable {
    ...
    public enum ReferralOriginator: String, Codable { 
        case friend = "FRIEND"
    ...
    public var referralOriginator: ReferralOriginator?

    public init(triggerId: String? = nil, triggerType: TriggerType? = nil, triggerPhase: TriggerPhase? = nil, triggerName: String? = nil, componentReferences: [CampaignComponentReferenceResponse]? = nil, referralOriginator: ReferralOriginator? = nil) {
        self.triggerId = triggerId
        self.triggerType = triggerType
        self.triggerPhase = triggerPhase
        self.triggerName = triggerName
        self.componentReferences = componentReferences
        self.referralOriginator = referralOriginator
    }
    ...
    public enum CodingKeys: String, CodingKey { 
        ...
        case referralOriginator = "referral_originator"
    }
