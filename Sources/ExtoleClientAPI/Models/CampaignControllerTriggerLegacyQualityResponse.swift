...
public struct CampaignControllerTriggerLegacyQualityResponse: Codable {
    ...
    public init(triggerId: String? = nil, triggerType: TriggerType? = nil, triggerPhase: TriggerPhase? = nil, triggerName: String? = nil, componentReferences: [CampaignComponentReferenceResponse]? = nil, actionType: BuildtimeEvaluatableControllerBuildtimeContextCampaignControllerTriggerActionType? = nil) {
