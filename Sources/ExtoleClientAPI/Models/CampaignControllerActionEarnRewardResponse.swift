//
// CampaignControllerActionEarnRewardResponse.swift
//
...
public struct CampaignControllerActionEarnRewardResponse: Codable {
    ...
    public var rewardSupplierId: BuildtimeEvaluatableControllerBuildtimeContextOptionalIdObject?
