//
// BuiltCampaignControllerActionShareEventResponse.swift
//
...
public struct BuiltCampaignControllerActionShareEventResponse: Codable {
    ...
    public init(actionId: String? = nil, actionType: ActionType? = nil, quality: Quality? = nil, componentReferences: [CampaignComponentReferenceResponse]? = nil) {
