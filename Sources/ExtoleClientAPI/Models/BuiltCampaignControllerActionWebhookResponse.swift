//
// BuiltCampaignControllerActionWebhookResponse.swift
//
...
public struct BuiltCampaignControllerActionWebhookResponse: Codable {
    ...
    public init(actionId: String? = nil, actionType: ActionType? = nil, quality: Quality? = nil, componentReferences: [CampaignComponentReferenceResponse]? = nil, webhookId: String? = nil, data: [String:RuntimeEvaluatableWebhookActionContextOptionalObject]? = nil) {
