...
open class PersonsV2Endpoints {
  ...
  "email" : "email"
    ...
    open class func callGetWithRequestBuilder(email: String? = nil, partnerUserId: String? = nil, lastName: String? = nil, limit: Int? = nil, offset: Int? = nil, partnerId: [String]? = nil) -> RequestBuilder<[PersonV2Response]> {
        ...
        let requestBuilder: RequestBuilder<[PersonV2Response]>.Type = ExtoleClientAPI.requestBuilderFactory.getBuilder()
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func create(body: PersonV2Request, completion: @escaping ((_ data: PersonV2Response?,_ error: Error?) -> Void)) {
  ...
  "email" : "email"
     ...
     - returns: RequestBuilder<PersonV2Response> 
     */
    open class func createWithRequestBuilder(body: PersonV2Request) -> RequestBuilder<PersonV2Response> {
        let path = "/v2/persons"
        let URLString = ExtoleClientAPI.basePath + path
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getAssociatedAdvocates(personId: String, completion: @escaping ((_ data: [RelationshipV2Response]?,_ error: Error?) -> Void)) {
        getAssociatedAdvocatesWithRequestBuilder(personId: personId).execute { (response, error) -> Void in
            completion(response?.body, error)
        }
    }
  ...
  "person" : {
     ...
     */
    open class func getAssociatedAdvocatesWithRequestBuilder(personId: String) -> RequestBuilder<[RelationshipV2Response]> {
        ...
        let requestBuilder: RequestBuilder<[RelationshipV2Response]>.Type = ExtoleClientAPI.requestBuilderFactory.getBuilder()
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getAssociatedFriends(personId: String, completion: @escaping ((_ data: [RelationshipV2Response]?,_ error: Error?) -> Void)) {
        getAssociatedFriendsWithRequestBuilder(personId: personId).execute { (response, error) -> Void in
            completion(response?.body, error)
        }
    }
  ...
  "person" : {
    ...
    "email" : "email"
     ...
     - returns: RequestBuilder<[RelationshipV2Response]> 
     */
    open class func getAssociatedFriendsWithRequestBuilder(personId: String) -> RequestBuilder<[RelationshipV2Response]> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getPerson(personId: String, completion: @escaping ((_ data: PersonV2Response?,_ error: Error?) -> Void)) {
  ...
  "email" : "email"
     ...
     - returns: RequestBuilder<PersonV2Response> 
     */
    open class func getPersonWithRequestBuilder(personId: String) -> RequestBuilder<PersonV2Response> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getReferralsToPerson(personId: String, completion: @escaping ((_ data: [RelationshipV2Response]?,_ error: Error?) -> Void)) {
        getReferralsToPersonWithRequestBuilder(personId: personId).execute { (response, error) -> Void in
            completion(response?.body, error)
        }
    }
  ...
  "person" : {
    ...
    "email" : "email"
     ...
     - returns: RequestBuilder<[RelationshipV2Response]> 
     */
    open class func getReferralsToPersonWithRequestBuilder(personId: String) -> RequestBuilder<[RelationshipV2Response]> {
  ...
  "is_same" : true
    ...
    open class func isSamePersonWithRequestBuilder(firstPersonId: String, personId: String? = nil) -> RequestBuilder<IsSamePersonV2Response> {
        ...
        let requestBuilder: RequestBuilder<IsSamePersonV2Response>.Type = ExtoleClientAPI.requestBuilderFactory.getBuilder()
