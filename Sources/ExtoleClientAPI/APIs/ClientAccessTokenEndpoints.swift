//
// ClientAccessTokenEndpoints.swift
//
...
open class ClientAccessTokenEndpoints {
    /**

     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func callGet(completion: @escaping ((_ data: AccessTokenResponse?,_ error: Error?) -> Void)) {
  ...
  "person_id" : "person_id"
     ...
     */
    open class func callGetWithRequestBuilder() -> RequestBuilder<AccessTokenResponse> {
        let path = "/v4/tokens"
        ...
        let requestBuilder: RequestBuilder<AccessTokenResponse>.Type = ExtoleClientAPI.requestBuilderFactory.getBuilder()
