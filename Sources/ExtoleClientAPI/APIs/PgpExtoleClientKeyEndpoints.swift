//
// PgpExtoleClientKeyEndpoints.swift
//
...
open class PgpExtoleClientKeyEndpoints {
    /**
  ...
  "algorithm" : "RSA"
    ...
    open class func archivePgpExtoleKeyWithRequestBuilder(keyId: String) -> RequestBuilder<PgpExtoleClientKeyResponse> {
        ...
        let requestBuilder: RequestBuilder<PgpExtoleClientKeyResponse>.Type = ExtoleClientAPI.requestBuilderFactory.getBuilder()
