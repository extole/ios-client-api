...
open class PrehandlerEndpoints {
    /**
     ...
     */
    open class func callGet(prehandlerId: String, completion: @escaping ((_ data: PrehandlerResponse?,_ error: Error?) -> Void)) {
        callGetWithRequestBuilder(prehandlerId: prehandlerId).execute { (response, error) -> Void in
  ...
  "order" : 0
     ...
     */
    open class func callGetWithRequestBuilder(prehandlerId: String) -> RequestBuilder<PrehandlerResponse> {
        ...
        let requestBuilder: RequestBuilder<PrehandlerResponse>.Type = ExtoleClientAPI.requestBuilderFactory.getBuilder()
