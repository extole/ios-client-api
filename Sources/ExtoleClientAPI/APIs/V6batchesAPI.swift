...
open class V6batchesAPI {
  ...
  "status" : "PENDING"
    ...
    open class func cancelWithRequestBuilder(batchId: String) -> RequestBuilder<BatchJobResponse> {
        ...
        let requestBuilder: RequestBuilder<BatchJobResponse>.Type = ExtoleClientAPIAPI.requestBuilderFactory.getBuilder()
  ...
  "content_length" : 0
    ...
    open class func infoWithRequestBuilder(batchId: String, format: String) -> RequestBuilder<BatchJobFormatInfoResponse> {
        ...
        let requestBuilder: RequestBuilder<BatchJobFormatInfoResponse>.Type = ExtoleClientAPIAPI.requestBuilderFactory.getBuilder()
