...
open class AudienceListEndpoints {
    /**
  ...
  "tags" : [ "tags", "tags" ]
    ...
    open class func archiveWithRequestBuilder(audienceId: String) -> RequestBuilder<AudienceListResponse> {
        ...
        let requestBuilder: RequestBuilder<AudienceListResponse>.Type = ExtoleClientAPI.requestBuilderFactory.getBuilder()
