...
open class V4personsAPI {
     ...
     */
    public enum Scope_getData1: String { 
        case _public = "PUBLIC"
     ...
     */
    open class func getData1(personId: String, name: String? = nil, scope: Scope_getData1? = nil, offset: Int? = nil, limit: Int? = nil, completion: @escaping ((_ data: [PersonDataResponse]?,_ error: Error?) -> Void)) {
        getData1WithRequestBuilder(personId: personId, name: name, scope: scope, offset: offset, limit: limit).execute { (response, error) -> Void in
  ...
  "value" : { }
     ...
     */
    open class func getData1WithRequestBuilder(personId: String, name: String? = nil, scope: Scope_getData1? = nil, offset: Int? = nil, limit: Int? = nil) -> RequestBuilder<[PersonDataResponse]> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getJourneys2(personId: String, campaignId: String? = nil, programLabel: String? = nil, container: String? = nil, type: String? = nil, offset: Int? = nil, limit: Int? = nil, completion: @escaping ((_ data: [PersonJourneyResponse]?,_ error: Error?) -> Void)) {
        getJourneys2WithRequestBuilder(personId: personId, campaignId: campaignId, programLabel: programLabel, container: container, type: type, offset: offset, limit: limit).execute { (response, error) -> Void in
            completion(response?.body, error)
        }
    }
  ...
  "updated_date" : "2000-01-23T04:56:07.000+00:00"
     ...
     */
    open class func getJourneys2WithRequestBuilder(personId: String, campaignId: String? = nil, programLabel: String? = nil, container: String? = nil, type: String? = nil, offset: Int? = nil, limit: Int? = nil) -> RequestBuilder<[PersonJourneyResponse]> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getNetworkStats1(personId: String, container: String? = nil, excludeAnonymous: Bool? = nil, completion: @escaping ((_ data: PersonNetworkStatsResponse?,_ error: Error?) -> Void)) {
        getNetworkStats1WithRequestBuilder(personId: personId, container: container, excludeAnonymous: excludeAnonymous).execute { (response, error) -> Void in
            completion(response?.body, error)
        }
    }
  ...
  "ltv" : "ltv"
     ...
     */
    open class func getNetworkStats1WithRequestBuilder(personId: String, container: String? = nil, excludeAnonymous: Bool? = nil) -> RequestBuilder<PersonNetworkStatsResponse> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getPerson3(personId: String, completion: @escaping ((_ data: PersonResponse?,_ error: Error?) -> Void)) {
        getPerson3WithRequestBuilder(personId: personId).execute { (response, error) -> Void in
            completion(response?.body, error)
        }
    }
  ...
  "email" : "email"
     ...
     */
    open class func getPerson3WithRequestBuilder(personId: String) -> RequestBuilder<PersonResponse> {
     ...
     */
    public enum Role_getRelationships2: String { 
        case friend = "FRIEND"
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getRelationships2(personId: String, container: String? = nil, role: Role_getRelationships2? = nil, excludeAnonymous: Bool? = nil, includeDuplicateIdentities: Bool? = nil, includeSelfReferrals: Bool? = nil, offset: Int? = nil, limit: Int? = nil, completion: @escaping ((_ data: [PersonRelationshipResponse]?,_ error: Error?) -> Void)) {
        getRelationships2WithRequestBuilder(personId: personId, container: container, role: role, excludeAnonymous: excludeAnonymous, includeDuplicateIdentities: includeDuplicateIdentities, includeSelfReferrals: includeSelfReferrals, offset: offset, limit: limit).execute { (response, error) -> Void in
            completion(response?.body, error)
        }
    }
  ...
  "is_parent" : true
     ...
     */
    open class func getRelationships2WithRequestBuilder(personId: String, container: String? = nil, role: Role_getRelationships2? = nil, excludeAnonymous: Bool? = nil, includeDuplicateIdentities: Bool? = nil, includeSelfReferrals: Bool? = nil, offset: Int? = nil, limit: Int? = nil) -> RequestBuilder<[PersonRelationshipResponse]> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getRequestContexts2(personId: String, completion: @escaping ((_ data: [RequestContextResponse]?,_ error: Error?) -> Void)) {
        getRequestContexts2WithRequestBuilder(personId: personId).execute { (response, error) -> Void in
            completion(response?.body, error)
        }
    }
  ...
  "state" : {
     ...
     */
    open class func getRequestContexts2WithRequestBuilder(personId: String) -> RequestBuilder<[RequestContextResponse]> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getRewards1(personId: String, programLabel: String? = nil, campaignId: String? = nil, rewardState: String? = nil, rewardType: String? = nil, offset: Int? = nil, limit: Int? = nil, completion: @escaping ((_ data: [PersonRewardResponse]?,_ error: Error?) -> Void)) {
        getRewards1WithRequestBuilder(personId: personId, programLabel: programLabel, campaignId: campaignId, rewardState: rewardState, rewardType: rewardType, offset: offset, limit: limit).execute { (response, error) -> Void in
            completion(response?.body, error)
        }
    }
  ...
  "value_of_rewarded_event" : 0.8008281904610115
     ...
     */
    open class func getRewards1WithRequestBuilder(personId: String, programLabel: String? = nil, campaignId: String? = nil, rewardState: String? = nil, rewardType: String? = nil, offset: Int? = nil, limit: Int? = nil) -> RequestBuilder<[PersonRewardResponse]> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getShareableByCode2(personId: String, code: String, completion: @escaping ((_ data: PersonShareableResponse?,_ error: Error?) -> Void)) {
        getShareableByCode2WithRequestBuilder(personId: personId, code: code).execute { (response, error) -> Void in
            completion(response?.body, error)
        }
    }
  ...
  "person_id" : "person_id"
     ...
     */
    open class func getShareableByCode2WithRequestBuilder(personId: String, code: String) -> RequestBuilder<PersonShareableResponse> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getShareables2(personId: String, offset: Int? = nil, limit: Int? = nil, completion: @escaping ((_ data: [PersonShareableResponse]?,_ error: Error?) -> Void)) {
        getShareables2WithRequestBuilder(personId: personId, offset: offset, limit: limit).execute { (response, error) -> Void in
            completion(response?.body, error)
        }
    }
  ...
  "person_id" : "person_id"
     ...
     - returns: RequestBuilder<[PersonShareableResponse]> 
     */
    open class func getShareables2WithRequestBuilder(personId: String, offset: Int? = nil, limit: Int? = nil) -> RequestBuilder<[PersonShareableResponse]> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getShares1(personId: String, campaignId: String? = nil, partnerShareId: String? = nil, partnerId: String? = nil, offset: Int? = nil, limit: Int? = nil, completion: @escaping ((_ data: [PersonShareResponse]?,_ error: Error?) -> Void)) {
        getShares1WithRequestBuilder(personId: personId, campaignId: campaignId, partnerShareId: partnerShareId, partnerId: partnerId, offset: offset, limit: limit).execute { (response, error) -> Void in
            completion(response?.body, error)
        }
    }
  ...
  "message" : "message"
     ...
     */
    open class func getShares1WithRequestBuilder(personId: String, campaignId: String? = nil, partnerShareId: String? = nil, partnerId: String? = nil, offset: Int? = nil, limit: Int? = nil) -> RequestBuilder<[PersonShareResponse]> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getStats1(personId: String, container: String? = nil, completion: @escaping ((_ data: PersonStatsResponse?,_ error: Error?) -> Void)) {
        getStats1WithRequestBuilder(personId: personId, container: container).execute { (response, error) -> Void in
            completion(response?.body, error)
        }
    }
  ...
  "ltv" : "ltv"
     ...
     */
    open class func getStats1WithRequestBuilder(personId: String, container: String? = nil) -> RequestBuilder<PersonStatsResponse> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getSteps1(personId: String, name: String? = nil, container: String? = nil, campaignId: String? = nil, programLabel: String? = nil, partnerId: String? = nil, flowPath: String? = nil, visitType: String? = nil, offset: Int? = nil, limit: Int? = nil, completion: @escaping ((_ data: [PersonStepResponse]?,_ error: Error?) -> Void)) {
        getSteps1WithRequestBuilder(personId: personId, name: name, container: container, campaignId: campaignId, programLabel: programLabel, partnerId: partnerId, flowPath: flowPath, visitType: visitType, offset: offset, limit: limit).execute { (response, error) -> Void in
            completion(response?.body, error)
        }
    }
  ...
  "quality" : "HIGH"
     ...
     */
    open class func getSteps1WithRequestBuilder(personId: String, name: String? = nil, container: String? = nil, campaignId: String? = nil, programLabel: String? = nil, partnerId: String? = nil, flowPath: String? = nil, visitType: String? = nil, offset: Int? = nil, limit: Int? = nil) -> RequestBuilder<[PersonStepResponse]> {
