...
open class V6audienceListsAPI {
  ...
  "tags" : [ "tags", "tags" ]
    ...
    open class func archiveWithRequestBuilder(audienceId: String) -> RequestBuilder<AudienceListResponse> {
        ...
        let requestBuilder: RequestBuilder<AudienceListResponse>.Type = ExtoleClientAPIAPI.requestBuilderFactory.getBuilder()
  ...
  "tags" : [ "tags", "tags" ]
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func get(audienceId: String, completion: @escaping ((_ data: AudienceListResponse?,_ error: Error?) -> Void)) {
        getWithRequestBuilder(audienceId: audienceId).execute { (response, error) -> Void in
            completion(response?.body, error)
        }
    }
  ...
  "tags" : [ "tags", "tags" ]
     ...
     - returns: RequestBuilder<AudienceListResponse> 
     */
    open class func getWithRequestBuilder(audienceId: String) -> RequestBuilder<AudienceListResponse> {
