...
open class RuntimePersonEndpoints {
    /**
     ...
     */
    open class func callGet(email: String? = nil, partnerUserId: String? = nil, lastName: String? = nil, limit: Int? = nil, offset: Int? = nil, partnerId: [String]? = nil, completion: @escaping ((_ data: [PersonResponse]?,_ error: Error?) -> Void)) {
  ...
  "email" : "email"
     ...
     */
    open class func callGetWithRequestBuilder(email: String? = nil, partnerUserId: String? = nil, lastName: String? = nil, limit: Int? = nil, offset: Int? = nil, partnerId: [String]? = nil) -> RequestBuilder<[PersonResponse]> {
  ...
  "is_same" : true
    ...
    open class func isSamePersonWithRequestBuilder(firstPersonId: String, personId: String? = nil) -> RequestBuilder<IsSamePersonResponse> {
        ...
        let requestBuilder: RequestBuilder<IsSamePersonResponse>.Type = ExtoleClientAPI.requestBuilderFactory.getBuilder()
