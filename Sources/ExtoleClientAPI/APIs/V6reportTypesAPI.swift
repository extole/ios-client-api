...
open class V6reportTypesAPI {
  ...
  "parameters" : [ {
    ...
    open class func addReportTypeTagsWithRequestBuilder(body: [String], _id: String) -> RequestBuilder<ReportTypeResponse> {
        ...
        let requestBuilder: RequestBuilder<ReportTypeResponse>.Type = ExtoleClientAPIAPI.requestBuilderFactory.getBuilder()
  ...
  "parameters" : [ {
    ...
    open class func listReportTypeClientsWithRequestBuilder(_id: String) -> RequestBuilder<[String]> {
        ...
        let requestBuilder: RequestBuilder<[String]>.Type = ExtoleClientAPIAPI.requestBuilderFactory.getBuilder()
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func listReportTypes(reportTypeId: String? = nil, displayName: String? = nil, _description: String? = nil, visibility: Visibility_listReportTypes? = nil, tags: String? = nil, excludeTags: String? = nil, limit: Int? = nil, offset: Int? = nil, orderBy: OrderBy_listReportTypes? = nil, order: Order_listReportTypes? = nil, completion: @escaping ((_ data: [ReportTypeResponse]?,_ error: Error?) -> Void)) {
        listReportTypesWithRequestBuilder(reportTypeId: reportTypeId, displayName: displayName, _description: _description, visibility: visibility, tags: tags, excludeTags: excludeTags, limit: limit, offset: offset, orderBy: orderBy, order: order).execute { (response, error) -> Void in
            completion(response?.body, error)
        }
    }
  ...
  "parameters" : [ {
    ...
    "order" : 0
     ...
     - returns: RequestBuilder<[ReportTypeResponse]> 
     */
    open class func listReportTypesWithRequestBuilder(reportTypeId: String? = nil, displayName: String? = nil, _description: String? = nil, visibility: Visibility_listReportTypes? = nil, tags: String? = nil, excludeTags: String? = nil, limit: Int? = nil, offset: Int? = nil, orderBy: OrderBy_listReportTypes? = nil, order: Order_listReportTypes? = nil) -> RequestBuilder<[ReportTypeResponse]> {
        let path = "/v6/report-types"
        let URLString = ExtoleClientAPIAPI.basePath + path
        let parameters: [String:Any]? = nil
        var url = URLComponents(string: URLString)
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func listReportTypesWithClients(reportTypeId: String? = nil, displayName: String? = nil, _description: String? = nil, visibility: Visibility_listReportTypesWithClients? = nil, tags: String? = nil, excludeTags: String? = nil, limit: Int? = nil, offset: Int? = nil, orderBy: OrderBy_listReportTypesWithClients? = nil, order: Order_listReportTypesWithClients? = nil, completion: @escaping ((_ data: [ReportTypeWithClientsResponse]?,_ error: Error?) -> Void)) {
        listReportTypesWithClientsWithRequestBuilder(reportTypeId: reportTypeId, displayName: displayName, _description: _description, visibility: visibility, tags: tags, excludeTags: excludeTags, limit: limit, offset: offset, orderBy: orderBy, order: order).execute { (response, error) -> Void in
            completion(response?.body, error)
        }
    }
  ...
  "client_ids" : [ "client_ids", "client_ids" ]
     ...
     */
    open class func listReportTypesWithClientsWithRequestBuilder(reportTypeId: String? = nil, displayName: String? = nil, _description: String? = nil, visibility: Visibility_listReportTypesWithClients? = nil, tags: String? = nil, excludeTags: String? = nil, limit: Int? = nil, offset: Int? = nil, orderBy: OrderBy_listReportTypesWithClients? = nil, order: Order_listReportTypesWithClients? = nil) -> RequestBuilder<[ReportTypeWithClientsResponse]> {
        ...
        let requestBuilder: RequestBuilder<[ReportTypeWithClientsResponse]>.Type = ExtoleClientAPIAPI.requestBuilderFactory.getBuilder()
